...
description: "This lab involved reviewing and improving upon visualizations from the Wellcome Global Monitor 2018 Report. This involved data cleaning, identifying grammar of graphics, and thinking through visualization best practices."  
date: 04-14-2025
categories: [Data Visualization, Data Cleaning] # self-defined categories
draft: false # setting this to `true` will prevent your post from appearing on your listing page until you're ready!
image: preview_image.png
---

[View the code on GitHub](https://github.com/Alisa-Krasilnikov/lab-2)
...
6.  Country, percentage of people who answered ‘high trust,’ percentage of ‘medium trust,’ and percentage of ‘low trust.’

7.  Shape: country, color: trust percentage
